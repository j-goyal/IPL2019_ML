# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 20:15:39 2020
...
dataset = pd.read_csv('powerplay.csv',encoding='cp1252')
...
#export_csv = dataset1.to_csv(r'C:\Users\windows 10\Desktop\K_Means\ipl_batsman_powerplay.csv', index = None, header=True)
